...
cvox.ChromeVoxEventSuspender.withSuspendedEvents = function (a) {
    return function () {
...
cvox.ChromeVoxEventSuspender.makeSuspendableHandler = function (a, b) {
    return function () {
        return cvox.ChromeVoxEventSuspender.areEventsSuspended() ? b : a()
    }
};
