...
cvox.AndroidMathMap = function () {
    ...
    var a = this.store_.getDynamicConstraintValues();
    this.allDomains = a.domain;
    this.allStyles = a.style
};
cvox.AndroidMathMap.prototype.evaluate = function (a, b, c) {
    var d = "";
    b = cvox.MathStore.createDynamicConstraint(b, c);
    d = this.store_.lookupString(a, b);
...
cvox.AndroidMathMap.SYMBOL_MAPPINGS_ = [{
    ...
    },
    {
        ...
        mappings: {
            "default": {
                "default": "presentation form for vertical right white lenticular bracket"
            }
        },
        key: "FE18"
    }, {
