...
cvox.ObjectWalker.prototype.stopNodeDescent = function (a) {
    return cvox.DomUtil.isLeafNode(a)
};
cvox.AbstractNodeWalker.prototype.getDescription = function (a, b) {
    return cvox.DescriptionUtil.getDescriptionFromNavigation(a.end.node, b.start.node, !0, cvox.ChromeVox.verbosity)
};
cvox.ObjectWalker.prototype.getBraille = function (a, b) {
